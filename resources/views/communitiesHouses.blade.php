<x-layout>
    ...
    <div class="nav-margin">
        <x-current title="{{$community->name . ' namai'}}" icon="images/sandelis.svg">
        </x-current>
        <section class="section-users">
            ...
            <div class="blocks">
                <table id="table_id" class="component__table">
                    ...
                    <tbody>
                    @php
                        $houses = \App\Models\House::where('community_id', $community->id)->with('community')->get();
                    ...
                    @else
                        <tr class="global-empty">
                            <td >Šiai bendrijai nėra priskirta namų</td>
                        </tr>
                    @endif
                    </tbody>
                </table>
